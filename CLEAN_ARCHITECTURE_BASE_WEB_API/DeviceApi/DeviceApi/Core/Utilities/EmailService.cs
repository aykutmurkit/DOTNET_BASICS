            ...
            <body>
                <div class='container'>
                    ...
                    <div class='content'>
                        ...
                        <p>Eğer bu giriş DeviceApisini siz yapmadıysanız, lütfen şifrenizi değiştirin.</p>
                    </div>
                    <div class='footer'>
                        <p>Bu e-posta, hesap güvenliğiniz için otomatik olarak gönderilmiştir.</p>
                        <p>&copy; {DateTime.Now.Year} - DeviceApi API</p>
                    </div>
                </div>
            </body>
            </html>";
        ...
        private string GetRandomPasswordEmailTemplate(string username, string password)
        {
            ...
            <body>
                <div class='container'>
                    ...
                    <div class='content'>
                        <p>Merhaba <strong>{username}</strong>,</p>
                        <p>DeviceApi API sistemine hoş geldiniz. Hesabınız başarıyla oluşturuldu.</p>
