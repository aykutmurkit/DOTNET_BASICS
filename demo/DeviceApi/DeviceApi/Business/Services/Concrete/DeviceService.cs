        ...
        private async Task<DeviceDto> MapToDeviceDtoAsync(Device device)
        {
            ...
            if (device.Settings != null)
            {
                deviceDto.Settings = new DeviceSettingsDto
                {
                    ...
                    FtpIp = device.Settings.FtpIp,
                    FtpPort = device.Settings.FtpPort,
                    FtpUsername = device.Settings.FtpUsername,
                    FtpPassword = device.Settings.FtpPassword,
                    ConnectionTimeoutDuration = device.Settings.ConnectionTimeoutDuration,
                    CommunicationHardwareVersion = device.Settings.CommunicationHardwareVersion,
                    CommunicationSoftwareVersion = device.Settings.CommunicationSoftwareVersion,
                    GraphicsCardHardwareVersion = device.Settings.GraphicsCardHardwareVersion,
                    GraphicsCardSoftwareVersion = device.Settings.GraphicsCardSoftwareVersion,
                    ScrollingTextSpeed = device.Settings.ScrollingTextSpeed,
                    TramDisplayType = device.Settings.TramDisplayType,
                    BusScreenPageCount = device.Settings.BusScreenPageCount,
                    TimeDisplayFormat = device.Settings.TimeDisplayFormat,
                    TramFont = device.Settings.TramFont,
                    ScreenVerticalPixelCount = device.Settings.ScreenVerticalPixelCount,
                    ScreenHorizontalPixelCount = device.Settings.ScreenHorizontalPixelCount,
                    TemperatureAlarmThreshold = device.Settings.TemperatureAlarmThreshold,
                    HumidityAlarmThreshold = device.Settings.HumidityAlarmThreshold,
                    GasAlarmThreshold = device.Settings.GasAlarmThreshold,
                    LightSensorStatus = device.Settings.LightSensorStatus,
                    LightSensorOperationLevel = device.Settings.LightSensorOperationLevel,
                    LightSensorLevel1 = device.Settings.LightSensorLevel1,
                    LightSensorLevel2 = device.Settings.LightSensorLevel2,
                    LightSensorLevel3 = device.Settings.LightSensorLevel3,
                    SocketType = device.Settings.SocketType,
                    StopName = device.Settings.StopName,
                    StartupLogoFilename = device.Settings.StartupLogoFilename,
                    StartupLogoCrc16 = device.Settings.StartupLogoCrc16,
                    VehicleLogoFilename = device.Settings.VehicleLogoFilename,
                    VehicleLogoCrc16 = device.Settings.VehicleLogoCrc16,
                    CommunicationType = device.Settings.CommunicationType,
