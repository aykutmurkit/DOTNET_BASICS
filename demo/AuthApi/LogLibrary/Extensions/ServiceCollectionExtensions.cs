...
using LogLibrary.Data.Context;
using LogLibrary.Data.Repositories;
using LogLibrary.Services.Concrete;
...
{
    /// <summary>
    /// LogLibrary servislerinin DI container'a kaydedilmesi için extension metotları
    /// </summary>
    public static class ServiceCollectionExtensions
    {
        /// <summary>
        /// LogLibrary servislerini DI container'a kaydeder
        /// </summary>
        /// <param name="services">IServiceCollection</param>
        /// <param name="configuration">IConfiguration</param>
        /// <returns>IServiceCollection</returns>
        public static IServiceCollection AddLogLibrary(this IServiceCollection services, IConfiguration configuration = null)
        {
            var configBuilder = new ConfigurationBuilder();
            
            // LogLibrary assembly'sindeki settings.json dosyasını oku
            ...
            var LogLibraryConfig = configBuilder.Build();
            
            // Yapılandırma bulunamazsa varsayılan ayarları kullan
            var logSettings = new LogSettings();
            LogLibraryConfig.GetSection("LogSettings").Bind(logSettings);
