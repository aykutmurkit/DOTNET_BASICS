            ...
            <body>
                <div class='container'>
                    ...
                    <div class='content'>
                        ...
                        <p>Eğer bu giriş AuthApisini siz yapmadıysanız, lütfen şifrenizi değiştirin.</p>
                    </div>
                    <div class='footer'>
                        <p>Bu e-posta, hesap güvenliğiniz için otomatik olarak gönderilmiştir.</p>
                        <p>&copy; {DateTime.Now.Year} - AuthApi API</p>
                    </div>
                </div>
            </body>
            </html>";
        ...
        private string GetRandomPasswordEmailTemplate(string username, string password)
        {
            ...
            <body>
                <div class='container'>
                    ...
                    <div class='content'>
                        <p>Merhaba <strong>{username}</strong>,</p>
                        <p>AuthApi API sistemine hoş geldiniz. Hesabınız başarıyla oluşturuldu.</p>
